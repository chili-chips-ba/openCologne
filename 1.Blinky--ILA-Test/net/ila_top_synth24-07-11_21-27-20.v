...
module ila_top(i_sclk_ILA, i_mosi_ILA, o_miso_ILA, clk, led, i_ss_ILA);
  ...
  CC_LUT4 #(
    ...
    .I0(\mem_control.addr_cnt_wd_pip [8]),
  ...
  CC_BRAM_20K #(
    ...
    .B_DI(20'hxxxxx),
    .B_DO({ _129_, _130_[4:3], \mem_control.BRAM_do_tmp[0] [2:0] }),
    .B_EN(1'h1),
    .B_WE(1'h0)
  );
  ...
  assign _113_[0] = 1'h0;
  assign _114_[23:0] = _113_[24:1];
  assign _115_[0] = 1'h0;
  assign _116_[7:0] = _115_[8:1];
  assign _118_[0] = 1'h0;
  assign _119_[7:0] = _118_[8:1];
  assign _121_[0] = 1'h0;
  assign _122_[7:0] = _121_[8:1];
  assign _124_[0] = 1'h0;
  assign _125_[7:0] = _124_[8:1];
  assign _130_[2:0] = \mem_control.BRAM_do_tmp[0] [2:0];
  assign _133_[3:1] = { ila_reset_register_sclk, state_trigger_conf };
  assign { _134_[2], _134_[0] } = { \spi_passiv.i_ss , \spi_passiv.tx_shift_reg [2] };
  assign { _135_[3], _135_[1:0] } = { ila_reset_register_sclk, \change_trigger.i_nib [1], trigger_column[1] };
  assign _136_[0] = trigger_column[2];
  assign { _137_[3], _137_[1:0] } = { ila_reset_register_sclk, \change_trigger.i_nib [1], trigger_activation[1] };
  assign _138_[1:0] = { \spi_passiv.bit_cnt [0], \spi_passiv.bit_cnt [1] };
  assign { _139_[2], _139_[0] } = { \mem_control.i_slave_end_byte_post_edge , conf_trigger_start };
  assign _140_[2:1] = { _134_[3], \spi_passiv.i_ss  };
  assign { _141_[3:2], _141_[0] } = { ila_reset_register_clk, \mem_control.i_trigger_triggered , \mem_control.i_reset  };
  assign _142_[1:0] = { \change_trigger.i_nib [3], \change_trigger.i_nib [1] };
  assign _143_[1] = _134_[3];
