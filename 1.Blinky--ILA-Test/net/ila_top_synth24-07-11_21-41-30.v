...
module ila_top(i_sclk_ILA, i_mosi_ILA, o_miso_ILA, clk, led, i_ss_ILA);
  ...
  wire [8:0] \mem_control.addr_cnt_rd ;
  wire [8:0] \mem_control.addr_cnt_wd ;
  wire [8:0] \mem_control.addr_cnt_wd_pip ;
  wire \mem_control.genblk4.byte_from_smp.i_read_active ;
  wire \mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ;
  wire \mem_control.genblk4.byte_from_smp.o_rd ;
  wire [3:0] \mem_control.genblk4.byte_from_smp.o_send_nib ;
  wire \mem_control.genblk4.byte_from_smp.rd ;
  wire \mem_control.genblk4.byte_from_smp.shift_counter ;
  wire [7:0] \mem_control.genblk4.byte_from_smp.shift_reg ;
  wire \mem_control.genblk4.byte_from_smp.signal_old ;
  ...
  wire [8:0] \mem_control.wd_counter ;
  ...
  CC_LUT3 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.o_send_nib [2]),
    .I1(\mem_control.genblk4.byte_from_smp.i_read_active ),
  ...
  CC_LUT4 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I1(read_active_pipe),
  ...
  CC_LUT4 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.o_send_nib [1]),
    .I1(\mem_control.genblk4.byte_from_smp.i_read_active ),
  ...
  CC_LUT4 #(
    ...
    .I2(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
  ...
  CC_LUT4 #(
    ...
    .I3(\mem_control.save_before_done ),
    .O(_101_)
  );
  CC_LUT4 #(
    .INIT(16'hca00)
  ...
  CC_LUT3 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.signal_old ),
    .I1(\mem_control.genblk4.byte_from_smp.rd ),
    .I2(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .O(_099_)
  );
  CC_LUT3 #(
    .INIT(8'h40)
  ...
  CC_LUT4 #(
    ...
    .I0(conf_trigger_start),
    .I1(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
    .I2(state_trigger_conf[0]),
    .I3(state_trigger_conf[1]),
    .O(_149_[1])
  );
  CC_LUT4 #(
    .INIT(16'hf800)
  ...
  CC_LUT2 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I1(\mem_control.genblk4.byte_from_smp.shift_reg [3]),
    .O(_097_)
  );
  CC_LUT2 #(
    .INIT(4'h4)
  ...
  CC_LUT3 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
    .I1(\mem_control.genblk4.byte_from_smp.shift_counter ),
    .I2(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .O(_147_[0])
  );
  CC_LUT2 #(
  ...
  CC_LUT2 #(
    ...
    .I0(_147_[0]),
    .I1(\mem_control.BRAM_do_tmp[0] [4]),
    .O(_025_)
  );
  CC_LUT2 #(
    .INIT(4'h8)
  ...
  CC_LUT2 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I1(\mem_control.genblk4.byte_from_smp.shift_reg [2]),
    .O(_096_)
  );
  CC_LUT2 #(
    .INIT(4'h8)
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I1(\mem_control.genblk4.byte_from_smp.shift_reg [1]),
    .O(_095_)
  );
  CC_LUT2 #(
    .INIT(4'h8)
    ...
    .I0(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I1(\mem_control.genblk4.byte_from_smp.shift_reg [0]),
    .O(_094_)
  );
  CC_LUT3 #(
    .INIT(8'h60)
  ) _205_ (
    .I0(\mem_control.genblk4.byte_from_smp.shift_counter ),
    .I1(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
    .I2(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .O(_093_)
  );
  CC_LUT3 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.rd ),
    .I1(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
    .I2(_147_[0]),
    .O(_092_)
  );
  ...
  CC_LUT4 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.o_send_nib [0]),
    .I1(\mem_control.genblk4.byte_from_smp.i_read_active ),
  ...
  CC_LUT3 #(
    ...
    .I0(\mem_control.BRAM_do_tmp[0] [0]),
    .I1(\mem_control.genblk4.byte_from_smp.shift_reg [4]),
    .I2(_147_[0]),
    .O(_123_)
  );
  CC_LUT2 #(
  ...
  CC_LUT3 #(
    ...
    .I0(_129_[0]),
    .I1(_132_[0]),
    .I2(\mem_control.genblk4.byte_from_smp.o_rd ),
    .O(_114_)
  );
  CC_LUT3 #(
    .INIT(8'hca)
  ...
  CC_LUT2 #(
    ...
    .I0(_147_[0]),
    .I1(\mem_control.BRAM_do_tmp[0] [3]),
    .O(_024_)
  );
  CC_LUT4 #(
    .INIT(16'hca00)
  ...
  CC_LUT4 #(
    ...
    .I0(\mem_control.genblk4.byte_from_smp.o_send_nib [3]),
    .I1(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .I2(\spi_passiv.rx_shift_reg [3]),
    .I3(\mem_control.o_write_done ),
    .O(_154_[2])
  );
  CC_LUT4 #(
  ...
  CC_DFF #(
    ...
    .D(_022_),
    .EN(_002_),
    .Q(\mem_control.genblk4.byte_from_smp.shift_reg [1]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_023_),
    .EN(_002_),
    .Q(\mem_control.genblk4.byte_from_smp.shift_reg [2]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_024_),
    .EN(_002_),
    .Q(\mem_control.genblk4.byte_from_smp.shift_reg [3]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_025_),
    .EN(_002_),
    .Q(\mem_control.genblk4.byte_from_smp.shift_reg [4]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_123_),
    .EN(_002_),
    .Q(\mem_control.genblk4.byte_from_smp.shift_reg [0]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
  ...
  CC_DFF #(
    ...
    .D(_034_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.i_read_active ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
  ...
  CC_DFF #(
    ...
    .D(_052_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h1),
  ...
  CC_DFF #(
    ...
    .D(_092_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.rd ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
  ...
  CC_DFF #(
    ...
    .D(_093_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.shift_counter ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_094_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.o_send_nib [0]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_095_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.o_send_nib [1]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_096_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.o_send_nib [2]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .D(_097_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.o_send_nib [3]),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
    ...
    .CLK(\spi_passiv.i_sclk ),
    .D(\mem_control.genblk4.byte_from_smp.rd ),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.signal_old ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
  ...
  CC_DFF #(
    ...
    .D(_099_),
    .EN(1'h1),
    .Q(\mem_control.genblk4.byte_from_smp.o_rd ),
    .SR(1'h0)
  );
  CC_DFF #(
    .CLK_INV(1'h0),
  ...
  CC_BRAM_20K #(
    ...
    .A_ADDR({ 3'h0, \mem_control.addr_cnt_wd_pip [8:3], 1'h0, \mem_control.addr_cnt_wd_pip [2:0], 3'h0 }),
    .A_BM({ 15'h0000, _004_, _004_, _004_, _004_, _004_ }),
    .A_CLK(clk180),
    .A_DI({ 15'h0000, \DUT.clk , \DUT.clk0 , \DUT.clk180 , \DUT.clk270 , \DUT.counter_5_0  }),
    .A_DO(_142_),
    .A_EN(1'h1),
    .A_WE(_004_),
    .B_ADDR({ 3'h0, \mem_control.addr_cnt_rd [8:3], 1'h0, \mem_control.addr_cnt_rd [2:0], 3'h0 }),
    .B_BM(20'h00000),
    .B_CLK(\spi_passiv.i_sclk ),
    .B_DI(20'hxxxxx),
    .B_DO({ _141_, \mem_control.BRAM_do_tmp[0]  }),
    .B_EN(1'h1),
    .B_WE(1'h0)
  );
  ...
  assign _127_[0] = 1'h0;
  assign _128_[7:0] = _127_[8:1];
  assign _130_[0] = 1'h0;
  assign _131_[7:0] = _130_[8:1];
  assign _133_[0] = 1'h0;
  assign _134_[7:0] = _133_[8:1];
  assign _136_[0] = 1'h0;
  assign _137_[7:0] = _136_[8:1];
  assign _144_[2:1] = { ila_reset_register_sclk, state_trigger_conf[1] };
  assign { _145_[2], _145_[0] } = { \change_trigger.i_nib [1], \change_trigger.i_nib [3] };
  assign _147_[1] = \mem_control.BRAM_do_tmp[0] [4];
  assign { _148_[3], _148_[1:0] } = { ila_reset_register_sclk, \change_trigger.i_nib [2], trigger_column[2] };
  assign { _149_[2], _149_[0] } = { ila_reset_register_sclk, \mem_control.i_reset  };
  assign { _150_[3:2], _150_[0] } = { ila_reset_register_clk, \mem_control.i_trigger_triggered , \mem_control.i_reset  };
  assign { _151_[3:2], _151_[0] } = { _146_[1], \spi_passiv.i_ss , \spi_passiv.tx_shift_reg [0] };
  assign { _152_[2], _152_[0] } = { trigger_column[2], trigger_pipe[4] };
  assign _153_[2:1] = { _146_[1], \spi_passiv.i_ss  };
  assign _154_[1:0] = { \spi_passiv.bit_cnt [0], \spi_passiv.bit_cnt [1] };
  assign { _155_[2], _155_[0] } = { \mem_control.genblk4.byte_from_smp.i_slave_end_byte_post_edge , conf_trigger_start };
  assign { \DUT.counter [24], \DUT.counter [4] } = { \DUT.led , \DUT.counter_5_0  };
  assign { \mem_control.addr_cnt_wd [8], \mem_control.addr_cnt_wd [5] } = { \mem_control.wd_cnt_done_edge.i_signal , \mem_control.save_before_done_edge.i_signal  };
  assign \mem_control.genblk4.byte_from_smp.shift_reg [7:5] = 3'h0;
  assign \mem_control.wd_counter [8] = \mem_control.write_done_edge.i_signal ;
