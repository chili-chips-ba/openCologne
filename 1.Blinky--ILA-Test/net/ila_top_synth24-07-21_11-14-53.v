...
module ila_top(i_sclk_ILA, i_mosi_ILA, o_miso_ILA, clk, led, i_ss_ILA);
  ...
  CC_BRAM_20K #(
    ...
    .B_DI(20'hxxxxx),
    .B_DO({ _125_, _126_[4:1], \mem_control.BRAM_do_tmp[0] [0] }),
    .B_EN(1'h1),
    .B_WE(1'h0)
  );
  ...
  assign _109_[0] = 1'h0;
  assign _110_[23:0] = _109_[24:1];
  assign _111_[0] = 1'h0;
  assign _112_[7:0] = _111_[8:1];
  assign _114_[0] = 1'h0;
  assign _115_[7:0] = _114_[8:1];
  assign _117_[0] = 1'h0;
  assign _118_[7:0] = _117_[8:1];
  assign _120_[0] = 1'h0;
  assign _121_[7:0] = _120_[8:1];
  assign _126_[0] = \mem_control.BRAM_do_tmp[0] [0];
  assign _129_[2:0] = { \spi_passiv.i_ss , \spi_passiv.rx_shift_reg [0], \change_trigger.i_nib [0] };
  assign { _130_[3], _130_[1:0] } = { ila_reset_register_sclk, \change_trigger.i_nib [2], trigger_column[2] };
  assign { _131_[2], _131_[0] } = { \mem_control.i_slave_end_byte_post_edge , conf_trigger_start };
  assign { _132_[3], _132_[1:0] } = { ila_reset_register_sclk, \change_trigger.i_nib [0], trigger_activation[0] };
  assign _133_[2:1] = { ila_reset_register_sclk, state_trigger_conf[1] };
  assign { _134_[2], _134_[0] } = { \change_trigger.i_nib [3], \change_trigger.i_nib [1] };
  assign _135_[3:1] = { ila_reset_register_clk, \mem_control.i_trigger_triggered , \mem_control.i_reset  };
  assign _136_[2:1] = { _129_[3], \spi_passiv.i_ss  };
  assign _137_[1:0] = { \spi_passiv.rx_shift_reg [3], \mem_control.o_write_done  };
  assign _138_[0] = _129_[3];
  assign _139_[2:0] = { _137_[2], \spi_passiv.rx_shift_reg [1], \mem_control.o_write_done  };
