...
#from amaranth.vendor import TemplatedPlatform
        ...
        **TemplatedPlatform.build_script_templates,
        ...
        "{{name}}.ccf": r"""
            ...
            {% for port_name, pin_name, attrs in platform.iter_port_constraints_bits() -%}
                {{ "Pin_in" if attrs.get("dir") == "i" else "Pin_out" if attrs.get("dir") == "o" else "Pin_inout" }} "{{port_name}}" Loc = "{{pin_name}}" {% if attrs %} | {{ attrs | join(" | ") }} {% endif %};
            {% endfor %}
        """,
        "{{name}}.sdc": r"""
            # {{autogenerated}}
