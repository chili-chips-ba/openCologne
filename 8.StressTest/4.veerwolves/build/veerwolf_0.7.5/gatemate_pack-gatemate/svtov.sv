...
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/include/el2_def.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lib/el2_lib.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lib/beh_lib.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/el2_mem.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/el2_pic_ctrl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/el2_dma_ctrl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_aln_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_compress_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_ifc_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_bp_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_ic_mem.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_mem_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu_iccm_mem.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/ifu/el2_ifu.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec_decode_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec_gpr_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec_ib_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec_tlu_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec_trigger.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dec/el2_dec.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/exu/el2_exu_alu_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/exu/el2_exu_mul_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/exu/el2_exu_div_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/exu/el2_exu.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_bus_buffer.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_clkdomain.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_addrcheck.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_lsc_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_stbuf.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_bus_intf.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_ecc.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_dccm_mem.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_dccm_ctl.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lsu/el2_lsu_trigger.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dbg/el2_dbg.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dmi/dmi_wrapper.v"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dmi/dmi_jtag_to_core_sync.v"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/dmi/rvjtag_tap.v"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/lib/mem_lib.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/el2_veer.sv"
`include "src/chipsalliance.org_cores_VeeR_EL2_1.4/design/el2_veer_wrapper.sv"
