...
class TestPipeline(cfg: ConfigP, complexity: Int, length: Int, maxWidth: Int, num: Int) extends TestPipelineIO(cfg.startWidth) {
...
BOARD   = Tang Nano 20K
PROJECT = $project
CHIPDB  = /home/nikola/ChiliChips/openCologne/pnr_tests-gowin/GW2AR-18C/LQFP176.json
...
//    ChiselStage.emitFIRRTLDialect(new TestPipeline(k, l, m, i))
    ChiselStage.emitSystemVerilog(new CSTGen(() => new TestPipelineIO(64), outdir, project, part, partpath))
